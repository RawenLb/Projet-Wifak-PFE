...
/**
 * Configuration Feign pour propager le JWT vers les services en aval.
 * Même logique que dans le validation-service.
 */
@Configuration
    ...
    public RequestInterceptor jwtRequestInterceptor() {
        return requestTemplate -> {
            ...
            if (auth != null && auth.getCredentials() instanceof Jwt jwt) {
                log.debug("🔑 Feign JWT propagé depuis SecurityContext");
                requestTemplate.header("Authorization", "Bearer " + jwt.getTokenValue());
                return;
            }

            // ── Stratégie 2 : depuis le header HTTP entrant ──
            ...
            if (attrs != null) {
                ...
                // ── Stratégie 3 : Internal Secret (appel depuis validation-service) ──
            ...
            log.warn("⚠️ Feign : aucun JWT disponible pour la requête");
        };
    }
}
