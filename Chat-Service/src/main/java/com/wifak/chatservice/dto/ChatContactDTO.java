...
public class ChatContactDTO {
    ...
    public static class Builder {
        ...
        public ChatContactDTO build() {
            ...
            dto.id = this.id; dto.username = this.username; dto.fullName = this.fullName;
            dto.role = this.role; dto.online = this.online; dto.unread = this.unread;
            dto.lastMsg = this.lastMsg; dto.lastTime = this.lastTime;
            return dto;
        }
    }
