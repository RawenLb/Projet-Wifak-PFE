package com.wifak.chatservice.entities;
...
public class ChatMessage {
    ...
    public static class Builder {
        ...
        public Builder editedAt(LocalDateTime v)       { this.editedAt = v; return this; }
        ...
        public Builder isForwarded(Boolean v)          { this.isForwarded = v; return this; }

        public ChatMessage build() {
            ChatMessage m = new ChatMessage();
            m.id = this.id; m.senderId = this.senderId; m.senderName = this.senderName;
            m.senderRole = this.senderRole; m.recipientId = this.recipientId;
            m.recipientName = this.recipientName; m.content = this.content;
            m.type = this.type; m.fileName = this.fileName; m.fileUrl = this.fileUrl;
            m.sentAt = this.sentAt; m.readAt = this.readAt; m.isRead = this.isRead;
            m.editedAt = this.editedAt; m.deletedAt = this.deletedAt;
            m.isDeleted = this.isDeleted; m.isForwarded = this.isForwarded;
            return m;
        }
    }
}
